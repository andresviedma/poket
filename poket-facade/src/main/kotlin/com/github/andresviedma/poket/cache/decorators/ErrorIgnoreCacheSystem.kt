...
import com.github.andresviedma.poket.cache.CacheConfig
import com.github.andresviedma.poket.cache.CacheSystem
import com.github.andresviedma.poket.cache.CacheTypeConfig
...
internal class ErrorIgnoreCacheSystem(
    ...
    private val defaultConfig: CacheTypeConfig?
    ...
    private suspend fun getConfig(): CacheTypeConfig =
        configProvider.get<CacheConfig>().getTypeConfig(type, defaultConfig)
}
