...
data class CacheTypeConfig(
    ...
    fun overriddenWith(typeOverride: CacheTypeConfig?) = CacheTypeConfig(
        ...
        distributedComponentNamespace = typeOverride?.distributedComponentNamespace ?: distributedComponentNamespace,
