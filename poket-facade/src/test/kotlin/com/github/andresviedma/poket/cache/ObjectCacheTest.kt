...
import com.github.andresviedma.poket.cache.decorators.ObjectCacheTransactionHandler
import com.github.andresviedma.poket.config.configWith
import com.github.andresviedma.poket.mutex.local.LocalLockSystem
import com.github.andresviedma.poket.mutex.local.distributedMutexFactoryStub
import com.github.andresviedma.poket.support.async.DefaultPoketAsyncRunner
import com.github.andresviedma.poket.support.async.PoketAsyncRunnerProvider
import com.github.andresviedma.poket.support.serialization.ClassPoketSerializer
import com.github.andresviedma.poket.support.serialization.PoketSerializer
import com.github.andresviedma.poket.testutils.Metric
import com.github.andresviedma.poket.testutils.generatedMetrics
import com.github.andresviedma.poket.testutils.testMicrometerRegistry
...
class ObjectCacheTest : FeatureSpec({
    ...
    fun CacheConfig.withErrorConfigHandling(override: CacheTypeConfig.() -> CacheTypeConfig) =
        copy(type = mapOf("error" to CacheTypeConfig(cacheSystem = errorCacheSystem.getId()).override()))
    ...
    feature("get") {
        ...
        Where(
            row("component namespace", CacheTypeConfig(distributedComponentNamespace = "myservice"), "myservice-test-1"),
